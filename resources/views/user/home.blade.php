                        ...
                        -->
                            ...
                            <li>
                                ...
                                <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right">
                                    ...
                                    @else
                                      <li><a href="{{ route('login') }}" class="font-semibold text-gray-600 hover:text-gray-900 focus:outline focus:    outline-red-500">Log in</a></li>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-xs-12">
                    <div class="left-text-content">
                        ...
                        <p>Klassy Cafe is one of the best experience for online retaurant booking. It is developed by Khushi & Faeez on Laravel Framework. This project is best project developed in the batch. This project have Sign Up, Sign In, CRUD Operations, Reservation system, etc.</p>
                        <div class="row">
                            <div class="col-4">
    ...
    <footer>
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-xs-12">
                    <div class="left-text-content">
                        <p>© 2023 Copyright Khushi & Faeez.All right reserved
